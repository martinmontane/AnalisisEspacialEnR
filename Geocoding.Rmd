...
```{r}
load(file = url("https://github.com/martinmontane/AnalisisEspacialEnR/raw/master/data/geocodingSaludExample.RData"))
```
...
```{r}
load(url("https://github.com/martinmontane/AnalisisEspacialEnR/raw/master/data/saludGCBA.RData"))
```
