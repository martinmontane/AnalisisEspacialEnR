...
Luego, usamos la función de **geocode()** de hereR, que solo nos pide un vector con las direcciones a geolocalizar. Para esto, antes deben usar **set_key()** para que here maps sea capaz de asociar las consultas con su cuenta
